...
And body should contains following information
    ...
    */
    ...
    public void test(){
        ...
        List<String> actualZips = jsonPath.getList("places.'post code'");//I am not giving index of places because i want to get List

        assertEquals(expectedZips,actualZips);

        //from emre
        System.out.println(jsonPath.getString("places.latitude"));// this shortcut directly gives you array in string format
        assertEquals("[42.4464, 42.4128]",jsonPath.getString("places.latitude"));

        //verify "post code": "02178" that "latitude": "42.4464"
        //GPATH syntax comes with "it statement" : you can use it like a coding algorithm

        String expectedLatitude = "[42.4464]";
        String actaulLatitude = jsonPath.getString("places.findAll {it.'post code'==\"02178\"}.latitude");

        assertEquals(expectedLatitude,actaulLatitude);
