...
public class CBTrainingApiWithJsonPath  {
    ...
    @Test
    public void test1(){
        //send a get request to student id 32181 as a path parameter and accept header application/json
        ...
        Response response = given().accept(ContentType.JSON).and().pathParam("id", 32881)
