...
public class SpartanGetRequests {
    ...
    String baseUrl = "http://54.144.126.242:8000";
    ...
    @DisplayName("Get one spartan/api/spartans/3 and verify") // you can give display name
    @Test
    public void test2(){
    ...
    public void test3(){
        ...
        //we use hasHeaderWithName method to verify header exist or not - it returns boolean value
